...
use AgeekDev\DevLogin\Http\Controllers\PhpInfoController;
...
Route::middleware('auth:'.config('dev-login.auth.guard_name', 'developer'))->group(function () {
    ...
    Route::get('info', [PhpInfoController::class, 'index'])->name('dev-login.info')
        ->middleware(EnsurePhpInfoIsEnabled::class);
